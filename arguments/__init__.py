...
class PipelineParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.debug = False
        self.mv = 1
        # [2D-GS] depth_ratio for pseudo surface normal calculation
        self.depth_ratio = 0.0
        # [LOD] Distance-driven hybrid rendering parameters
        self.lod_near_limit = 2.0       # Cascade 0 boundary (full 2D-GS)
        self.lod_transition_limit = 6.0 # Cascade 1 boundary (stochastic 2D-GS)
        self.lod_min_prob = 0.2         # Minimum keep probability (inverse-depth sampling)
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        # [2D-GS] Geometric regularization parameters
        self.lambda_normal = 0.05  # weight of normal consistency loss
